...
<div class="container">
    ...
    <form id="filterForm" method="GET" class="mb-4 flex items-center gap-2" style="text-align-last: end">
        <input type="text" name="q" id="q" placeholder="Cari kode, nama barang, atau supplier..." value="{{ request('q') }}" class="border px-2 py-1 rounded" style="text-align-last: start;">
